...
})({"4H4hj":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "d1e7c5587c782bca";
...
const logout = async ()=>{
    try {
        ...
        console.log(res);
        res.formData.status = "success";
        (0, _alerts.showAlert)("info", "logged out");
        window.setTimeout(()=>{
            location.assign("/");
        }, 1500);
    } catch (err) {
...
},{"./../utils":"5By4s"}]},["4H4hj","f2QDv"], "f2QDv", "parcelRequire2aee")
